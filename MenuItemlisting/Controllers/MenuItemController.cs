...
namespace MenuItemListing.Controllers
{
    ...
    public class MenuItemController : ControllerBase
    {
        ...
        public List<MenuItem> GetItem()
        {
            ...
            {   new MenuItem() {Id=1, Name="Phone", Active=true, DateOfLaunch=new DateTime(2022,07,03), FreeDelivery=false,Price=10000},
                new MenuItem() {Id=2, Name="LapTop", Active=false, DateOfLaunch=new DateTime(2018,08,03), FreeDelivery=false,Price=20000}
